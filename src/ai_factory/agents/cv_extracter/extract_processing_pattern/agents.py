...
cv_file_processing_pattern_agent = Agent(
...
async def main():
    OUTPUT_DIR = "custom_outputs/file_processing_pattern_section"
    CONCURRENCY = 20
    file_section = "file_processing_pattern_section"
    ...
    tasks = [
        asyncio.create_task(
            process_file(
                ...
                output_key=output_key,
                agent=cv_file_processing_pattern_agent,
